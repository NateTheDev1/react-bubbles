...
- [ ] Explain what a token is used for.
  ...
  A token is used to verify authentication when making requests from the frontend to the backend. The token verifies the current user and allows requests like deleting or updating, posting, and getting data to be made.

- [ ] What steps can you take in your web apps to keep your data secure?

  You can require proper authentication before allowing requests. Also you can require proper Auth for privated routes such as profiles, or other sensitive material after a user logs in.

- [ ] Describe how web servers work.

  There are static web servers and dynamic web servers. The web server communicates with the browser sending files to the user (The user can now see the webpage or content they requested). The web server is in a physical place that stores the files.
